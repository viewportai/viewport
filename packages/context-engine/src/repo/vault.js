...
class ContextVault {
  ...
  createIdentity(name) {
    return identities.createIdentity(this.home, name);
  }
  ...
  createDeviceApprovalRequest(options) {
    return devices.createDeviceApprovalRequest(this.home, options);
  }
  ...
  acceptDeviceApproval(options) {
    return devices.acceptDeviceApproval(this.home, options);
  }

  getIdentity(name) {
    return identities.getIdentity(this.home, name);
  }
